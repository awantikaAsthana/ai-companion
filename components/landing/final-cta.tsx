...
export function FinalCta() {
  return (
    <section className="relative py-10 sm:py-18 lg:py-32 border-t border-[#430D15]/40 overflow-hidden text-center">
      ...
      <motion.div
        ...
        className="pointer-events-none absolute -bottom-10 -left-6 sm:left-4 md:left-12 w-20 sm:w-44 md:w-56 filter drop-shadow-[0_15px_30px_rgba(0,0,0,0.9)] drop-shadow-[0_0_25px_rgba(110,7,23,0.4)] opacity-60 sm:opacity-85"
      >
        <img
      ...
      <motion.div
        ...
        className="pointer-events-none absolute -top-8 -right-6 sm:right-4 md:right-12 w-20 sm:w-40 md:w-52 filter drop-shadow-[0_15px_30px_rgba(0,0,0,0.9)] drop-shadow-[0_0_25px_rgba(110,7,23,0.4)] opacity-60 sm:opacity-85"
      >
        <img
      ...
      <div className="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        >
          ...
          <h2 className="font-serif text-3xl sm:text-5xl md:text-7xl lg:text-8xl font-light tracking-tight text-[#F5E9E5] mb-3 sm:mb-5 leading-[1.08] sm:leading-[1.05]">
            Ready to meet yours?
          </h2>

          <p className="max-w-[42ch] mx-auto text-sm sm:text-lg lg:text-2xl font-light leading-relaxed text-[#BFA8A8] mb-6 sm:mb-8 lg:mb-12">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <Link
              href="/signup"
              className="group relative inline-flex items-center justify-center rounded-full bg-gradient-to-r from-[#6E0717] via-[#8F1025] to-[#6E0717] w-full sm:w-auto min-h-[48px] px-8 sm:px-12 py-4 sm:py-5 text-sm sm:text-base font-medium uppercase tracking-[0.16em] text-[#F5E9E5] shadow-[0_0_35px_rgba(110,7,23,0.5)] transition-all duration-300 hover:shadow-[0_0_55px_rgba(181,30,58,0.7)] hover:scale-[1.02] active:scale-[0.98] touch-manipulation"
            >
