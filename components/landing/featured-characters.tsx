...
export function FeaturedCharacters() {
  ...
  return (
    <section id="characters" className="relative py-8 sm:py-14 lg:py-24 border-t border-[#430D15]/30">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        {/* Editorial Section Header */}
        <div className="mb-6 sm:mb-10 lg:mb-14 flex flex-col md:flex-row md:items-end md:justify-between gap-3 sm:gap-6">
          <motion.div
          ...
          <p className="max-w-[42ch] text-sm sm:text-base lg:text-lg font-light text-[#BFA8A8] leading-relaxed">
        ...
        <div className="flex md:grid md:grid-cols-2 lg:grid-cols-12 gap-6 lg:gap-8 overflow-x-auto snap-x snap-mandatory md:overflow-visible pb-4 md:pb-0 -mx-4 px-4 sm:mx-0 sm:px-0">
